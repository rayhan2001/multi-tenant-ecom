    ...
    <Layout>
        ...
        <main class="ml-64 p-8">
            ...
            <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
                ...
                <div class="mb-4">
                    <img :src="brandImage" alt="Brand Image" class="w-20 h-20 rounded-full mb-2">
                </div>
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md">Edit Brand</button>
            </form>
        </main>
    </Layout>
</template>
